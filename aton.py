   ...
   def ProcessRequest(self,callbacks,request):
      ...
      if request['value'] != 'get':
         if (requestName[0] == 'source'):
            ...
            self.write_to_serial_port('&AH66,KEY,,0000','1')
            self.write_to_serial_port('&AH66,KEY,1,0000','1')
            self.write_to_serial_port('&AH66,KEY,2,0000','1')
            self.write_to_serial_port('&AH66,KEY,3,0000','1')
            self.write_to_serial_port('&AH66,KEY,4,0000','1')
            self.write_to_serial_port('&AH66,KEY,5,0000','1')
            self.write_to_serial_port('&AH66,KEY,6,0000','1')
            self.write_to_serial_port('&AH66,KEY,7,0000','1')
            self.write_to_serial_port('&AH66,KEY,8,0000','1')
            self.write_to_serial_port('&AH66,KEY,9,0000','1')
            self.write_to_serial_port('&AH66,KEY,10,0000','1')
            self.write_to_serial_port('&AH66,KEY,11,0000','1')
